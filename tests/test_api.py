...
class Wikirate4PyTests(Wikirate4PyTestCase):
    ...
    @tape.use_cassette('test_get_company.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_companies.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_metric.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_metrics.yaml', serializer='yaml')
    def test_get_metrics(self):
        metrics = self.api.get_metrics(limit=10)
        self.assertTrue(isinstance(metrics[0], MetricItem))
        self.assertEqual(len(metrics), 10)

    @tape.use_cassette('test_get_topic.yaml', serializer='yaml')
    def test_get_topic(self):
        topic = self.api.get_topic('Wikirate ESG Topics+Environment')
        self.assertTrue(isinstance(topic, Topic))
        self.assertEqual(topic.id, 39152)

    @tape.use_cassette('test_get_topics.yaml', serializer='yaml')
    def test_get_topics(self):
        topics = self.api.get_topics(limit=10)
        self.assertTrue(isinstance(topics[0], TopicItem))
        self.assertEqual(topics[0].framework, "Wikirate ESG Topics")
        self.assertEqual(len(topics), 10)

    @tape.use_cassette('test_get_research_group.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_research_groups.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_company_group.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_source.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_sources.yaml', serializer='yaml')
    def test_get_sources(self):
        sources = self.api.get_sources(limit=10)
        self.assertTrue(isinstance(sources[0], SourceItem))
        self.assertEqual(len(sources), 10)

    @tape.use_cassette('test_get_answer.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_answers.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_dataset_answers.yaml', serializer='yaml')
    def test_get_dataset_answers(self):
        answers = self.api.get_answers(identifier="ShareAction Workforce Insights Data", limit=10)
        self.assertTrue(isinstance(answers[0], AnswerItem))
        self.assertEqual(len(answers), 10)

    @tape.use_cassette('test_get_relationship.yaml', serializer='yaml')
    ...
    @tape.use_cassette('get_relationships.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_dataset.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_datasets.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_get_regions.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_search_source_by_url.yaml', serializer='yaml')
    ...
    def test_add_and_remove_company(self):
        company = self.api.add_company(name='My Test Co. Inc.',
                                       headquarters='United Kingdom')
        self.assertTrue(isinstance(company, Company))
        self.assertEqual(company.name, 'My Test Co. Inc.')
        self.assertEqual(self.api.delete_wikirate_entity(company.id), True)

    @tape.use_cassette('test_search_by_name.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_add_source.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_update_source.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_add_answer.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_update_research_metric_answer.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_add_relationship.yaml', serializer='yaml')
    ...
    @tape.use_cassette('test_update_relationship.yaml', serializer='yaml')
